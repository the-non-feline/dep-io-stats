...
The only option here is to wait until it works again.", inline=False)
        embed.add_field(name=f"Or maybe it's just being slow {chars.sleepy_shark}", value=f"""I ain't got the patience \
to wait more than {self.REQUEST_TIMEOUT} seconds for a map to load. 
